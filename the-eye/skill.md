...
| Material Design | Follows Material principles | [ ] |
| Navigation | Platform-native patterns | [ ] |
| Gestures | Expected gesture behaviors | [ ] |
...
| Network | Handles poor connectivity | [ ] |
...
| Privacy | Privacy policy, data disclosure | [ ] |
...
| Pricing logic | Justified, value-based | [ ] |
| Guarantee | Clear, reasonable guarantee | [ ] |
...
| Timeline | Delivered when promised | [ ] |
...
| Method selection | Appropriate for question | [ ] |
| Sample size | Adequate for conclusions | [ ] |
| Bias control | Bias minimized/acknowledged | [ ] |
...
| Credibility | Sources are credible | [ ] |
...
| Transparency | Not deceptive | [ ] |
| Autonomy | Respects user choice | [ ] |
| Harm avoidance | No psychological harm | [ ] |
...
| Context appropriate | Applied correctly | [ ] |
...
| Correct interpretation | Accurate understanding | [ ] |
...
| Execution | Plan executed effectively | [ ] |
...
| On spec | Meets requirements | [ ] |
| On budget | Within budget | [ ] |
| Quality | Meets quality standards | [ ] |
| Stakeholder satisfaction | Stakeholders satisfied | [ ] |
...
## Quick Stats
- Audits completed: [X]
- Findings raised: [X] (Critical: X, High: X, Medium: X, Low: X)
- Findings resolved: [X]
- Overdue items: [X]

## Key Findings This Week
1. [Most important finding with brief context]
2. [Second finding]
3. [Third finding]
...
- [Issue requiring Mohammad's input]
